...
// Entry rule entryRuleOpaqueBehaviorBody
entryRuleOpaqueBehaviorBody 
:
{ before(grammarAccess.getOpaqueBehaviorBodyRule()); }
	 ruleOpaqueBehaviorBody
{ after(grammarAccess.getOpaqueBehaviorBodyRule()); } 
	 EOF 
;

// Rule OpaqueBehaviorBody
ruleOpaqueBehaviorBody
    @init {
	...
	:
(
{ before(grammarAccess.getOpaqueBehaviorBodyAccess().getBodydefinitionAssignment()); }
(rule__OpaqueBehaviorBody__BodydefinitionAssignment)
{ after(grammarAccess.getOpaqueBehaviorBodyAccess().getBodydefinitionAssignment()); }
)
...
:
(
{ before(grammarAccess.getOpaqueBehaviorBodyAccess().getBodydefinitionBlockParserRuleCall_0()); }
	ruleBlock{ after(grammarAccess.getOpaqueBehaviorBodyAccess().getBodydefinitionBlockParserRuleCall_0()); }
)
