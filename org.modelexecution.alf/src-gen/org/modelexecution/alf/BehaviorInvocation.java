 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.BehaviorInvocation#getTuple <em>Tuple</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getBehaviorInvocation()
 * @model
 * @generated
 */
public interface BehaviorInvocation extends EObject
{
   ...
   * @see #setTuple(Tuple)
   * @see org.modelexecution.alf.AlfPackage#getBehaviorInvocation_Tuple()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.BehaviorInvocation#getTuple <em>Tuple</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
