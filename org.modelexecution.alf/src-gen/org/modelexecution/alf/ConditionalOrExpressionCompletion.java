 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ConditionalOrExpressionCompletion#getConditionalAndExpressionCompletion <em>Conditional And Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.ConditionalOrExpressionCompletion#getConditionalAndExpression <em>Conditional And Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getConditionalOrExpressionCompletion()
 * @model
 * @generated
 */
public interface ConditionalOrExpressionCompletion extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getConditionalOrExpressionCompletion_ConditionalAndExpressionCompletion()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ConditionalOrExpressionCompletion#getConditionalAndExpressionCompletion <em>Conditional And Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.modelexecution.alf.ConditionalAndExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getConditionalOrExpressionCompletion_ConditionalAndExpression()
   * @model containment="true"
   * @generated
   */
