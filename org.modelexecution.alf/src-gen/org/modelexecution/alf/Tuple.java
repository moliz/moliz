 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.Tuple#getNamedTupleExpressionList <em>Named Tuple Expression List</em>}</li>
 *   <li>{@link org.modelexecution.alf.Tuple#getPositionalTupleExpressionList <em>Positional Tuple Expression List</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getTuple()
 * @model
 * @generated
 */
public interface Tuple extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getTuple_NamedTupleExpressionList()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.Tuple#getNamedTupleExpressionList <em>Named Tuple Expression List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getTuple_PositionalTupleExpressionList()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.Tuple#getPositionalTupleExpressionList <em>Positional Tuple Expression List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
