 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.InclusiveOrExpressionCompletion#getExclusiveOrExpressionCompletion <em>Exclusive Or Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.InclusiveOrExpressionCompletion#getExclusiveOrExpression <em>Exclusive Or Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getInclusiveOrExpressionCompletion()
 * @model
 * @generated
 */
public interface InclusiveOrExpressionCompletion extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getInclusiveOrExpressionCompletion_ExclusiveOrExpressionCompletion()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.InclusiveOrExpressionCompletion#getExclusiveOrExpressionCompletion <em>Exclusive Or Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.modelexecution.alf.ExclusiveOrExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getInclusiveOrExpressionCompletion_ExclusiveOrExpression()
   * @model containment="true"
   * @generated
   */
