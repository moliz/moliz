 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.AliasDefinition#getAlias <em>Alias</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getAliasDefinition()
 * @model
 * @generated
 */
public interface AliasDefinition extends EObject
{
   ...
   * @see #setAlias(Name)
   * @see org.modelexecution.alf.AlfPackage#getAliasDefinition_Alias()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.AliasDefinition#getAlias <em>Alias</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
