 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.NameToPrimaryExpression#getLinkOperationCompletion <em>Link Operation Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.NameToPrimaryExpression#getClassExtentExpressionCompletion <em>Class Extent Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.NameToPrimaryExpression#getSequenceConstructionCompletion <em>Sequence Construction Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.NameToPrimaryExpression#getBehaviorInvocation <em>Behavior Invocation</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getNameToPrimaryExpression()
 * @model
 * @generated
 */
public interface NameToPrimaryExpression extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getNameToPrimaryExpression_LinkOperationCompletion()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.NameToPrimaryExpression#getLinkOperationCompletion <em>Link Operation Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getNameToPrimaryExpression_ClassExtentExpressionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.NameToPrimaryExpression#getClassExtentExpressionCompletion <em>Class Extent Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getNameToPrimaryExpression_SequenceConstructionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.NameToPrimaryExpression#getSequenceConstructionCompletion <em>Sequence Construction Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getNameToPrimaryExpression_BehaviorInvocation()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.NameToPrimaryExpression#getBehaviorInvocation <em>Behavior Invocation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
