 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getIndexNamedExpressionListCompletion <em>Index Named Expression List Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getPrimaryToExpressionCompletion <em>Primary To Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getPositionalTupleExpressionListCompletion <em>Positional Tuple Expression List Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getIndexedNamedExpressionListCompletion <em>Indexed Named Expression List Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getNameToExpressionCompletion <em>Name To Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.impl.LinkOperationTupleImpl#getPositionalTupleExpressionList <em>Positional Tuple Expression List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
