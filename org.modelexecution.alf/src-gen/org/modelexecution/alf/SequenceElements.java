 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.SequenceElements#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link org.modelexecution.alf.SequenceElements#getExpression2 <em>Expression2</em>}</li>
 *   <li>{@link org.modelexecution.alf.SequenceElements#getSequenceElementListCompletion <em>Sequence Element List Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.SequenceElements#getSequenceInitializationExpression <em>Sequence Initialization Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getSequenceElements()
 * @model
 * @generated
 */
public interface SequenceElements extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getSequenceElements_Expression1()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SequenceElements#getExpression1 <em>Expression1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getSequenceElements_Expression2()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SequenceElements#getExpression2 <em>Expression2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getSequenceElements_SequenceElementListCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SequenceElements#getSequenceElementListCompletion <em>Sequence Element List Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getSequenceElements_SequenceInitializationExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SequenceElements#getSequenceInitializationExpression <em>Sequence Initialization Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
