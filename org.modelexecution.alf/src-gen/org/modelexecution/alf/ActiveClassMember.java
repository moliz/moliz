 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ActiveClassMember#getComment <em>Comment</em>}</li>
 *   <li>{@link org.modelexecution.alf.ActiveClassMember#getStereotypeAnnotations <em>Stereotype Annotations</em>}</li>
 *   <li>{@link org.modelexecution.alf.ActiveClassMember#getVisibilityIndicator <em>Visibility Indicator</em>}</li>
 *   <li>{@link org.modelexecution.alf.ActiveClassMember#getActiveClassMemberDefinition <em>Active Class Member Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getActiveClassMember()
 * @model
 * @generated
 */
public interface ActiveClassMember extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getActiveClassMember_Comment()
   * @model
   * @generated
   */
  String getComment();
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActiveClassMember#getComment <em>Comment</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getActiveClassMember_StereotypeAnnotations()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActiveClassMember#getStereotypeAnnotations <em>Stereotype Annotations</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getActiveClassMember_VisibilityIndicator()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActiveClassMember#getVisibilityIndicator <em>Visibility Indicator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getActiveClassMember_ActiveClassMemberDefinition()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActiveClassMember#getActiveClassMemberDefinition <em>Active Class Member Definition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
