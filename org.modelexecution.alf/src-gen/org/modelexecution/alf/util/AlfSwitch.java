...
public class AlfSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        OpaqueBehaviorBody opaqueBehaviorBody = (OpaqueBehaviorBody)theEObject;
        T result = caseOpaqueBehaviorBody(opaqueBehaviorBody);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Opaque Behavior Body</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Opaque Behavior Body</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseOpaqueBehaviorBody(OpaqueBehaviorBody object)
  {
    return null;
  }
