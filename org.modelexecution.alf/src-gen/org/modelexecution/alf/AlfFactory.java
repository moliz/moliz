...
public interface AlfFactory extends EFactory
{
   ...
   * @generated
   */
  AlfFactory eINSTANCE = org.modelexecution.alf.impl.AlfFactoryImpl.init();

  /**
   * Returns a new object of class '<em>Opaque Behavior Body</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Opaque Behavior Body</em>'.
   * @generated
   */
  OpaqueBehaviorBody createOpaqueBehaviorBody();
