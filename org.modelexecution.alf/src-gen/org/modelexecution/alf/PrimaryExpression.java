 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.PrimaryExpression#getNameOrPrimaryExpression <em>Name Or Primary Expression</em>}</li>
 *   <li>{@link org.modelexecution.alf.PrimaryExpression#getBaseExpression <em>Base Expression</em>}</li>
 *   <li>{@link org.modelexecution.alf.PrimaryExpression#getParenthesizedExpression <em>Parenthesized Expression</em>}</li>
 *   <li>{@link org.modelexecution.alf.PrimaryExpression#getPrimaryExpressionCompletion <em>Primary Expression Completion</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getPrimaryExpression()
 * @model
 * @generated
 */
public interface PrimaryExpression extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getPrimaryExpression_NameOrPrimaryExpression()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PrimaryExpression#getNameOrPrimaryExpression <em>Name Or Primary Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPrimaryExpression_BaseExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PrimaryExpression#getBaseExpression <em>Base Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPrimaryExpression_ParenthesizedExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PrimaryExpression#getParenthesizedExpression <em>Parenthesized Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPrimaryExpression_PrimaryExpressionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PrimaryExpression#getPrimaryExpressionCompletion <em>Primary Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
