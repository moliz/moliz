 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ExclusiveOrExpressionCompletion#getAndExpressionCompletion <em>And Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.ExclusiveOrExpressionCompletion#getAndExpression <em>And Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getExclusiveOrExpressionCompletion()
 * @model
 * @generated
 */
public interface ExclusiveOrExpressionCompletion extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getExclusiveOrExpressionCompletion_AndExpressionCompletion()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ExclusiveOrExpressionCompletion#getAndExpressionCompletion <em>And Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.modelexecution.alf.AndExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getExclusiveOrExpressionCompletion_AndExpression()
   * @model containment="true"
   * @generated
   */
