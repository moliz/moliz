 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.InstanceCreationOrSequenceConstructionExpression#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link org.modelexecution.alf.InstanceCreationOrSequenceConstructionExpression#getSequenceConstructionExpressionCompletion <em>Sequence Construction Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.InstanceCreationOrSequenceConstructionExpression#getTuple <em>Tuple</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getInstanceCreationOrSequenceConstructionExpression()
 * @model
 * @generated
 */
public interface InstanceCreationOrSequenceConstructionExpression extends BaseExpression
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getInstanceCreationOrSequenceConstructionExpression_QualifiedName()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.InstanceCreationOrSequenceConstructionExpression#getQualifiedName <em>Qualified Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getInstanceCreationOrSequenceConstructionExpression_SequenceConstructionExpressionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.InstanceCreationOrSequenceConstructionExpression#getSequenceConstructionExpressionCompletion <em>Sequence Construction Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setTuple(Tuple)
   * @see org.modelexecution.alf.AlfPackage#getInstanceCreationOrSequenceConstructionExpression_Tuple()
   * @model containment="true"
   * @generated
   */
  Tuple getTuple();
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.InstanceCreationOrSequenceConstructionExpression#getTuple <em>Tuple</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
