 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ExclusiveOrExpression#getUnaryExpression <em>Unary Expression</em>}</li>
 *   <li>{@link org.modelexecution.alf.ExclusiveOrExpression#getExclusiveOrExpressionCompletion <em>Exclusive Or Expression Completion</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getExclusiveOrExpression()
 * @model
 * @generated
 */
public interface ExclusiveOrExpression extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getExclusiveOrExpression_UnaryExpression()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ExclusiveOrExpression#getUnaryExpression <em>Unary Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getExclusiveOrExpression_ExclusiveOrExpressionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ExclusiveOrExpression#getExclusiveOrExpressionCompletion <em>Exclusive Or Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
