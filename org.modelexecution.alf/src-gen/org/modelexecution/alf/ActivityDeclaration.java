 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ActivityDeclaration#getName <em>Name</em>}</li>
 *   <li>{@link org.modelexecution.alf.ActivityDeclaration#getTemplateParameters <em>Template Parameters</em>}</li>
 *   <li>{@link org.modelexecution.alf.ActivityDeclaration#getFormalParameters <em>Formal Parameters</em>}</li>
 *   <li>{@link org.modelexecution.alf.ActivityDeclaration#getTypePart <em>Type Part</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getActivityDeclaration()
 * @model
 * @generated
 */
public interface ActivityDeclaration extends EObject
{
   ...
   * @see #setName(Name)
   * @see org.modelexecution.alf.AlfPackage#getActivityDeclaration_Name()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActivityDeclaration#getName <em>Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getActivityDeclaration_TemplateParameters()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActivityDeclaration#getTemplateParameters <em>Template Parameters</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getActivityDeclaration_FormalParameters()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActivityDeclaration#getFormalParameters <em>Formal Parameters</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getActivityDeclaration_TypePart()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ActivityDeclaration#getTypePart <em>Type Part</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
