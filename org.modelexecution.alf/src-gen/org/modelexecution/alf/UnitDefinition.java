 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.UnitDefinition#getNamespaceDeclaration <em>Namespace Declaration</em>}</li>
 *   <li>{@link org.modelexecution.alf.UnitDefinition#getImportDeclarations <em>Import Declarations</em>}</li>
 *   <li>{@link org.modelexecution.alf.UnitDefinition#getComment <em>Comment</em>}</li>
 *   <li>{@link org.modelexecution.alf.UnitDefinition#getStereotypeAnnotations <em>Stereotype Annotations</em>}</li>
 *   <li>{@link org.modelexecution.alf.UnitDefinition#getNamesapceDefinition <em>Namesapce Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getUnitDefinition()
 * @model
 * @generated
 */
public interface UnitDefinition extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getUnitDefinition_NamespaceDeclaration()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.UnitDefinition#getNamespaceDeclaration <em>Namespace Declaration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.modelexecution.alf.ImportDeclaration}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getUnitDefinition_ImportDeclarations()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.modelexecution.alf.AlfPackage#getUnitDefinition_Comment()
   * @model
   * @generated
   */
  String getComment();
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.UnitDefinition#getComment <em>Comment</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getUnitDefinition_StereotypeAnnotations()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.UnitDefinition#getStereotypeAnnotations <em>Stereotype Annotations</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getUnitDefinition_NamesapceDefinition()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.UnitDefinition#getNamesapceDefinition <em>Namesapce Definition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
