 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.LinkOperationCompletion#getLinkOperation <em>Link Operation</em>}</li>
 *   <li>{@link org.modelexecution.alf.LinkOperationCompletion#getLinkOperationTuple <em>Link Operation Tuple</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getLinkOperationCompletion()
 * @model
 * @generated
 */
public interface LinkOperationCompletion extends EObject
{
   ...
   * The literals are from the enumeration {@link org.modelexecution.alf.LinkOperation}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getLinkOperationCompletion_LinkOperation()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.LinkOperationCompletion#getLinkOperation <em>Link Operation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getLinkOperationCompletion_LinkOperationTuple()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.LinkOperationCompletion#getLinkOperationTuple <em>Link Operation Tuple</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
