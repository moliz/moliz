 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ShiftExpressionCompletion#getAdditiveExpressionCompletion <em>Additive Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.ShiftExpressionCompletion#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.modelexecution.alf.ShiftExpressionCompletion#getAdditiveExpression <em>Additive Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getShiftExpressionCompletion()
 * @model
 * @generated
 */
public interface ShiftExpressionCompletion extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getShiftExpressionCompletion_AdditiveExpressionCompletion()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ShiftExpressionCompletion#getAdditiveExpressionCompletion <em>Additive Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.modelexecution.alf.ShiftOperator}.
   * The literals are from the enumeration {@link org.modelexecution.alf.ShiftOperator}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getShiftExpressionCompletion_Operator()
   * @model unique="false"
   * @generated
   */
   ...
   * The list contents are of type {@link org.modelexecution.alf.AdditiveExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getShiftExpressionCompletion_AdditiveExpression()
   * @model containment="true"
   * @generated
   */
