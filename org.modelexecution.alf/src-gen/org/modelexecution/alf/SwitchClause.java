 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.SwitchClause#getSwitchCase <em>Switch Case</em>}</li>
 *   <li>{@link org.modelexecution.alf.SwitchClause#getStatementSequence <em>Statement Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getSwitchClause()
 * @model
 * @generated
 */
public interface SwitchClause extends EObject
{
   ...
   * The list contents are of type {@link org.modelexecution.alf.SwitchCase}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getSwitchClause_SwitchCase()
   ...
   * @see org.modelexecution.alf.AlfPackage#getSwitchClause_StatementSequence()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SwitchClause#getStatementSequence <em>Statement Sequence</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
