 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.SuperInvocationExpression#getQualifiedName <em>Qualified Name</em>}</li>
 *   <li>{@link org.modelexecution.alf.SuperInvocationExpression#getTuple <em>Tuple</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getSuperInvocationExpression()
 * @model
 * @generated
 */
public interface SuperInvocationExpression extends BaseExpression
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getSuperInvocationExpression_QualifiedName()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SuperInvocationExpression#getQualifiedName <em>Qualified Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setTuple(Tuple)
   * @see org.modelexecution.alf.AlfPackage#getSuperInvocationExpression_Tuple()
   * @model containment="true"
   * @generated
   */
  Tuple getTuple();
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.SuperInvocationExpression#getTuple <em>Tuple</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
