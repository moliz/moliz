 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.ClassificationClause#getClassificationFromClause <em>Classification From Clause</em>}</li>
 *   <li>{@link org.modelexecution.alf.ClassificationClause#getClassificationToClause <em>Classification To Clause</em>}</li>
 *   <li>{@link org.modelexecution.alf.ClassificationClause#getReclassifyAllClause <em>Reclassify All Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getClassificationClause()
 * @model
 * @generated
 */
public interface ClassificationClause extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getClassificationClause_ClassificationFromClause()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ClassificationClause#getClassificationFromClause <em>Classification From Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getClassificationClause_ClassificationToClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ClassificationClause#getClassificationToClause <em>Classification To Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getClassificationClause_ReclassifyAllClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.ClassificationClause#getReclassifyAllClause <em>Reclassify All Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
