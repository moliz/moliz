 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.PostfixOrCastExpression#getNonNamePostfixOrCastExpression <em>Non Name Postfix Or Cast Expression</em>}</li>
 *   <li>{@link org.modelexecution.alf.PostfixOrCastExpression#getNameOrPrimaryExpression <em>Name Or Primary Expression</em>}</li>
 *   <li>{@link org.modelexecution.alf.PostfixOrCastExpression#getPostFixExpressionCompletion <em>Post Fix Expression Completion</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getPostfixOrCastExpression()
 * @model
 * @generated
 */
public interface PostfixOrCastExpression extends UnaryExpression, CastCompletion
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getPostfixOrCastExpression_NonNamePostfixOrCastExpression()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PostfixOrCastExpression#getNonNamePostfixOrCastExpression <em>Non Name Postfix Or Cast Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPostfixOrCastExpression_NameOrPrimaryExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PostfixOrCastExpression#getNameOrPrimaryExpression <em>Name Or Primary Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPostfixOrCastExpression_PostFixExpressionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PostfixOrCastExpression#getPostFixExpressionCompletion <em>Post Fix Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
