 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.AdditiveExpressionCompletion#getMultiplicativeExpressionCompletion <em>Multiplicative Expression Completion</em>}</li>
 *   <li>{@link org.modelexecution.alf.AdditiveExpressionCompletion#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.modelexecution.alf.AdditiveExpressionCompletion#getMultiplicativeExpression <em>Multiplicative Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getAdditiveExpressionCompletion()
 * @model
 * @generated
 */
public interface AdditiveExpressionCompletion extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getAdditiveExpressionCompletion_MultiplicativeExpressionCompletion()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.AdditiveExpressionCompletion#getMultiplicativeExpressionCompletion <em>Multiplicative Expression Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.modelexecution.alf.AdditiveOperator}.
   * The literals are from the enumeration {@link org.modelexecution.alf.AdditiveOperator}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getAdditiveExpressionCompletion_Operator()
   * @model unique="false"
   * @generated
   */
   ...
   * The list contents are of type {@link org.modelexecution.alf.MultiplicativeExpression}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getAdditiveExpressionCompletion_MultiplicativeExpression()
   * @model containment="true"
   * @generated
   */
