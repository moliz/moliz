 ...
 * <ul>
 *   <li>{@link org.modelexecution.alf.PackagedElement#getComment <em>Comment</em>}</li>
 *   <li>{@link org.modelexecution.alf.PackagedElement#getStereotypeAnnotations <em>Stereotype Annotations</em>}</li>
 *   <li>{@link org.modelexecution.alf.PackagedElement#getImportVisibilityIndicator <em>Import Visibility Indicator</em>}</li>
 *   <li>{@link org.modelexecution.alf.PackagedElement#getPackagedElementDefinition <em>Packaged Element Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.modelexecution.alf.AlfPackage#getPackagedElement()
 * @model
 * @generated
 */
public interface PackagedElement extends EObject
{
   ...
   * @see org.modelexecution.alf.AlfPackage#getPackagedElement_Comment()
   * @model
   * @generated
   */
  String getComment();
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PackagedElement#getComment <em>Comment</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPackagedElement_StereotypeAnnotations()
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PackagedElement#getStereotypeAnnotations <em>Stereotype Annotations</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link org.modelexecution.alf.ImportVisibilityIndicator}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.modelexecution.alf.AlfPackage#getPackagedElement_ImportVisibilityIndicator()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PackagedElement#getImportVisibilityIndicator <em>Import Visibility Indicator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.modelexecution.alf.AlfPackage#getPackagedElement_PackagedElementDefinition()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.modelexecution.alf.PackagedElement#getPackagedElementDefinition <em>Packaged Element Definition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
