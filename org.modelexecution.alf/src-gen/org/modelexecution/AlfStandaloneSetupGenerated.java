...
public class AlfStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.modelexecution.AlfRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.modelexecution.org/Alf")) {
		EPackage.Registry.INSTANCE.put("http://www.modelexecution.org/Alf", org.modelexecution.alf.AlfPackage.eINSTANCE);
	}
