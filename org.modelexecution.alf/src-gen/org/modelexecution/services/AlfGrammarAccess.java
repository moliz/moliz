...
* generated by Xtext
*/
package org.modelexecution.services;
...
public class AlfGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class OpaqueBehaviorBodyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "OpaqueBehaviorBody");
		private final Assignment cBodydefinitionAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cBodydefinitionBlockParserRuleCall_0 = (RuleCall)cBodydefinitionAssignment.eContents().get(0);
		
		/// *
		// * Rule additionally introduced for capturing bodies of opaque behaviors
		// * / OpaqueBehaviorBody:
		//	bodydefinition=Block;
		public ParserRule getRule() { return rule; }

		//bodydefinition=Block
		public Assignment getBodydefinitionAssignment() { return cBodydefinitionAssignment; }

		//Block
		public RuleCall getBodydefinitionBlockParserRuleCall_0() { return cBodydefinitionBlockParserRuleCall_0; }
	}
	...
	private OpaqueBehaviorBodyElements pOpaqueBehaviorBody;
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.modelexecution.Alf".equals(grammar.getName())) {
				return grammar;
			}
	...
	// * / OpaqueBehaviorBody:
	//	bodydefinition=Block;
	public OpaqueBehaviorBodyElements getOpaqueBehaviorBodyAccess() {
		return (pOpaqueBehaviorBody != null) ? pOpaqueBehaviorBody : (pOpaqueBehaviorBody = new OpaqueBehaviorBodyElements());
	}
	
	public ParserRule getOpaqueBehaviorBodyRule() {
		return getOpaqueBehaviorBodyAccess().getRule();
	}
